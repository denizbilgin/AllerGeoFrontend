...
class UserService {
  ...
  Future<AIAllergyAttackPredictionModel> fetchUserAllergyAttackById(int userId, int allergyId) async {
    try {
      final response = await http.get(Uri.parse("$usersUrl$userId/allergy-attacks/$allergyId"));
